#!/bin/bash
# ==============================================================================
# 🚀 ИНТЕРАКТИВНЫЙ ИНСТРУМЕНТ НАСТРОЙКИ И УПРАВЛЕНИЯ REMNANODE (v1.6.3)
# ==============================================================================
...
#  - Автоматическое открытие портов при установке с сохранением правил SSH/HTTP/HTTPS
...
generate_masked_template() {
    ...
    local selected_template; selected_template="${templates[$RANDOM % ${#templates[@]}]}"
...
main_menu() {
    while true; do
        ...
        echo -e "${GREEN}"
        echo "  ========================================================"
        echo "  🚀 REMNANODE ИНТЕРАКТИВНОЕ УПРАВЛЕНИЕ НОДОЙ (v1.6.3)"
        echo "  ========================================================"
        echo -e "${NC}"
