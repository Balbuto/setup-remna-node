...
Начиная с версии **v1.7.0**, скрипт содержит встроенный модуль **комплексного мульти-тестирования сервера (бенчмарки производительности, скорости сети и тесты DPI / геоблокировок)**, а также полноценный вынос логов Xray на хост и авторегистрацию при удаленном запуске одной строкой.
...
```
  ========================================================
  🚀 REMNANODE ИНТЕРАКТИВНОЕ УПРАВЛЕНИЕ НОДОЙ (v1.7.0)
  ========================================================
