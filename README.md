# 🚀 RemnaNode Advanced Installer & Optimizer CLI (v1.6.0)
...
Начиная с версии **v1.6.0**, скрипт содержит встроенную интеграцию профессионального мутатора **`uniquify-theme`** и коллекции адаптивных маскировочных сайтов из репозитория **[Mrvibecodic/node-templates](https://github.com/Mrvibecodic/node-templates)**. Это обеспечивает передовой уровень защиты от активного зондирования систем цензуры (DPI) за счет уникализации сигнатур, хэшей и размеров файлов "на лету".
...
* **Nginx на втором рубеже (Всегда активен)**: Контейнер `remnawave-nginx` принимает перенаправленный трафик от Xray по Unix-сокету и отдает уникальный, глубоко мутированный сайт-заглушку. Работает во всех режимах (и в TLS, и в Reality).
...
### 2. ⚙️ Системный Тюнинг и Оптимизация (BBR & Hardening)
...
### 3. ⚡ Версионный менеджмент Xray-Core
...
```
  ========================================================
  🚀 REMNANODE ИНТЕРАКТИВНОЕ УПРАВЛЕНИЕ НОДОЙ (v1.6.0)
  ========================================================
